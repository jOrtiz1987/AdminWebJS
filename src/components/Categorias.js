...
class Categorias extends React.Component {
  ...
  addUser = async () => {
    try {
      console.log('http://localhost:8080/api/categorias', this.state.formData);
      await axios.post('http://localhost:8080/api/categorias', this.state.formData);
  ...
  modifyUser = async (userId) => {
    try {
      console.log(`http://localhost:8080/api/categorias/${userId}`, this.state.formData);
      await axios.put(`http://localhost:8080/api/categorias/${userId}`, this.state.formData);
      this.fetchData(); // Recargar la lista de categorias
      this.handleCloseForm();
    } catch (error) {
  ...
  deleteUser = async (userId) => {
    try {
      console.log(`http://localhost:8080/api/categorias/${userId}`);
      await axios.delete(`http://localhost:8080/api/categorias/${userId}`);
      this.fetchData(); // Recargar la lista de categorias
    } catch (error) {
